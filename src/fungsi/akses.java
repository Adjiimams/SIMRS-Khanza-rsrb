...
public final class akses {
    ...
    private static boolean aktif=false,admin=false,user=false,vakum=false,aplikasi=false,penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,
            ...
            intervensi_nyeri_nonfarmakologi=false,surat_pengajuan_cuti_pasien=false,pemberian_informasi_medis_dan_non_medis=false,skrining_kecanduan_alkohol=false,checklist_kriteria_masuk_isolasi=false,satu_sehat_mapping_kptl_tindakan_ralan=false,
    ...
    public static boolean getpemberian_informasi_medis_dan_non_medis(){return akses.pemberian_informasi_medis_dan_non_medis;}
    public static boolean getskrining_kecanduan_alkohol(){return akses.skrining_kecanduan_alkohol;}
}