...
public final class RMSkriningMPPFormB extends javax.swing.JDialog {
    ...
    public RMSkriningMPPFormB(java.awt.Frame parent, boolean modal) {
        ...
        TMasalah.setDocument(new batasInput((int)2000).getKata(TMasalah));           
        TTinjut.setDocument(new batasInput((int)3000).getKata(TTinjut));           
    ...
    private void initComponents() {
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(192, 640));
        PanelInput.setLayout(new java.awt.BorderLayout(1, 1));

        FormInput.setName("FormInput"); // NOI18N
        FormInput.setPreferredSize(new java.awt.Dimension(100, 580));
        ...
        TMasalah.setBorder(javax.swing.BorderFactory.createEmptyBorder(2, 4, 2, 2));
        TMasalah.setColumns(20);
        TMasalah.setRows(8);
        TMasalah.setLineWrap(true);
        TMasalah.setWrapStyleWord(true);
        TMasalah.setFont(new java.awt.Font("Monospaced", 0, 11));
        ...
        scrollPane5.setBounds(89, 100, 646, 120);

        // === TINDAK LANJUT (Nomor 3 & 4) ===
        jLabel41.setText("Tindak Lanjut :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(0, 228, 85, 23);

        scrollPane6.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane6.setName("scrollPane6"); // NOI18N

        TTinjut.setBorder(javax.swing.BorderFactory.createEmptyBorder(2, 4, 2, 2));
        TTinjut.setColumns(20);
        TTinjut.setRows(12);
        TTinjut.setLineWrap(true);
        TTinjut.setWrapStyleWord(false);
        TTinjut.setFont(new java.awt.Font("Monospaced", 0, 11));
        ...
        scrollPane6.setBounds(89, 228, 646, 175);

        // === EVALUASI (Nomor 5 & 6) ===
        jLabel42.setText("Evaluasi :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(0, 411, 85, 23);

        scrollPane7.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane7.setName("scrollPane7"); // NOI18N

        TEvaluasi.setBorder(javax.swing.BorderFactory.createEmptyBorder(2, 4, 2, 2));
        TEvaluasi.setColumns(20);
        TEvaluasi.setRows(10);
        TEvaluasi.setLineWrap(true);
        TEvaluasi.setWrapStyleWord(false);
        TEvaluasi.setFont(new java.awt.Font("Monospaced", 0, 11));
        ...
        scrollPane7.setBounds(89, 411, 646, 160);
        ...
        // Bungkus internalFrame1 dengan JScrollPane agar seluruh halaman bisa di-scroll
        javax.swing.JScrollPane mainScroll = new javax.swing.JScrollPane(internalFrame1);
        mainScroll.setHorizontalScrollBarPolicy(javax.swing.JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        mainScroll.setVerticalScrollBarPolicy(javax.swing.JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
    ...
    private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
       isForm();
       // Isi template otomatis saat form input dibuka dan field masih kosong
       if(ChkInput.isSelected() && TMasalah.getText().trim().isEmpty()){
           emptTeks();
       }
    ...
    */
    ...
    // === TEMPLATE MASALAH ===
    private static final String TEMPLATE_MASALAH =
        "1. Rencana Pelayanan Pasien :\n\n\n\n" +
        "2. Monitoring Pelayanan/Asuhan Pasien Seluruh PPA (perkembangan, kolaborasi)\n" +
        "   verifikasi respon terhadap intervensi yang diberikan, revisi rencana asuhan\n" +
        "   termasuk preferensi perubahan, transisi pelayanan, dan kendala pelayanan :\n\n";
    
    // === TEMPLATE TINDAK LANJUT ===
    private static final String TEMPLATE_TINJUT =
        "3. Memfasilitasi Pelayanan :\n" +
        "   [ ] Konsultasi / Kolaborasi    :\n" +
        "   [ ] Second Opinion             :\n" +
        "   [ ] Rawat Bersama / Alih Rawat :\n" +
        "   [ ] Komunikasi / Edukasi       :\n" +
        "   [ ] Rujukan                    :\n" +
        "   [ ] Lain-lain                  :\n\n" +
        "4. Advokasi Pelayanan Pasien :\n" +
        "   [ ] Diskusi dengan PPA staf lain tentang kebutuhan pasien agar sesuai dengan PPK/CP\n" +
        "   [ ] Diskusi dengan PPA untuk penanganan Komplikasi\n" +
        "   [ ] Memberikan edukasi pasien dan keluarga tentang penyakit, kondisi terkini dan rencana pelayanan\n" +
        "   [ ] Meningkatkan kemandirian untuk menentukan pilihan / pengambilan keputusan\n" +
        "   [ ] Mengenali, mencegah, menghindari disparitas untuk mengakses mutu dan hasil pelayanan\n" +
        "       terkait dengan ras, etnik, agama, gender, budaya, status pernikahan, umur, politik,\n" +
        "       disabilitas fisik-mental-kognitif\n" +
        "   [ ] Membuat komunikasi dengan instansi terkait tentang upaya penyelesaian kendala keuangan\n" +
        "   [ ] Memberikan edukasi mengenai kondisi pasien\n" +
        "   [ ] Untuk pemenuhan kebutuhan pelayanan yang berkembang/bertambah karena perubahan kondisi";
    
    // === TEMPLATE EVALUASI ===
    private static final String TEMPLATE_EVALUASI =
        "5. Informasi Pelayanan / Hasil Asuhan Pasien :\n" +
        "   a. Sasaran :\n" +
        "   b. Keberhasilan, kualitas, kendala biaya efektif dari intervensi MPP\n" +
        "      mencapai sasaran asuhan :\n" +
        "   c. Nilai / laporan dampak pelaksanaan asuhan pasien :\n" +
        "   d. Catat utilitas sesuai panduan / norma :\n\n" +
        "6. Terminasi Pelayanan Pasien (Catatan Kepuasan Pasien/Keluarga dengan MPP) :\n" +
        "   [ ] Puas  [ ] Tidak puas  [ ] Abstain  [ ] Bermasalah\n" +
        "   [ ] Konflik/komplain  [ ] Keuangan\n" +
        "   [ ] Pasien perbaikan  [ ] Rujuk  [ ] Meninggal\n" +
        "   [ ] Lain-lain :";

    public void emptTeks() {
        TglImplementasi.setDate(new Date());
        TMasalah.setText(TEMPLATE_MASALAH);
        TTinjut.setText(TEMPLATE_TINJUT);
        TEvaluasi.setText(TEMPLATE_EVALUASI);
        TMasalah.setCaretPosition(0);
        TTinjut.setCaretPosition(0);
        TEvaluasi.setCaretPosition(0);
    ...
    public void setNoRm(String norwt, Date tgl2) {
        ...
        ChkInput.setSelected(true);
        isForm();
        // Isi template jika field masih kosong (buka pertama kali)
    ...
    private void isForm(){
        if(ChkInput.isSelected()==true){
            ...
            PanelInput.setPreferredSize(new Dimension(WIDTH, 640));
