...
public final class RMTriaseIGD extends javax.swing.JDialog {
    ...
    public RMTriaseIGD(java.awt.Frame parent, boolean modal) {
        ...
        // tambahan dr Puri BB/TB kebutuhan Klaim Ranap
        PrimerTB.setDocument(new batasInput((byte)5).getKata(PrimerTB));
        PrimerBB.setDocument(new batasInput((byte)5).getKata(PrimerBB));
        SekunderTB.setDocument(new batasInput((byte)5).getKata(SekunderTB));
        SekunderBB.setDocument(new batasInput((byte)5).getKata(SekunderBB));
        ...
        PrimerKeluhanUtama.setDocument(new batasInput((int)3000).getKata(PrimerKeluhanUtama));
        SekunderAnamnesa.setDocument(new batasInput((int)3000).getKata(SekunderAnamnesa));
    ...
    private void initComponents() {
        ...
        PrimerTB = new widget.TextBox();
        jLabel36 = new widget.Label();
        jLabel35 = new widget.Label();
        PrimerBB = new widget.TextBox();
        ...
        SekunderTB = new widget.TextBox();
        jLabel40 = new widget.Label();
        SekunderBB = new widget.TextBox();
        ...
        PrimerSaturasi.setBounds(60, 70, 40, 23);
        ...
        PrimerRespirasi.setBounds(170, 70, 55, 23);

        jLabel27.setText("RR(/menit) :");
        jLabel27.setName("jLabel27"); // NOI18N
        internalFrame7.add(jLabel27);
        jLabel27.setBounds(100, 70, 70, 23);
        ...
        PrimerTB.setHighlighter(null);
        PrimerTB.setName("PrimerTB"); // NOI18N
        PrimerTB.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PrimerTBKeyPressed(evt);
            }
        });
        internalFrame7.add(PrimerTB);
        PrimerTB.setBounds(260, 70, 40, 23);

        jLabel36.setText("TB :");
        jLabel36.setName("jLabel36"); // NOI18N
        internalFrame7.add(jLabel36);
        jLabel36.setBounds(230, 70, 30, 23);

        jLabel35.setText("BB :");
        jLabel35.setName("jLabel35"); // NOI18N
        internalFrame7.add(jLabel35);
        jLabel35.setBounds(300, 70, 30, 23);

        PrimerBB.setHighlighter(null);
        PrimerBB.setName("PrimerBB"); // NOI18N
        PrimerBB.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PrimerBBKeyPressed(evt);
            }
        });
        internalFrame7.add(PrimerBB);
        PrimerBB.setBounds(335, 70, 40, 23);
        ...
        PrimerTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-07-2026 18:17:19" }));
        ...
        jLabel17.setText("SP O² (%) :");
        jLabel17.setName("jLabel17"); // NOI18N
        internalFrame11.add(jLabel17);
        jLabel17.setBounds(10, 70, 60, 23);
        ...
        SekunderSaturasi.setBounds(70, 70, 55, 23);
        ...
        SekunderRespirasi.setBounds(200, 70, 55, 23);

        jLabel33.setText("RR (/menit) :");
        jLabel33.setName("jLabel33"); // NOI18N
        internalFrame11.add(jLabel33);
        jLabel33.setBounds(120, 70, 70, 23);
        ...
        SekunderTensi.setBounds(300, 70, 55, 23);

        jLabel15.setText("Tensi :");
        jLabel15.setName("jLabel15"); // NOI18N
        internalFrame11.add(jLabel15);
        jLabel15.setBounds(260, 70, 40, 23);

        jLabel39.setText("Tb :");
        jLabel39.setName("jLabel39"); // NOI18N
        internalFrame11.add(jLabel39);
        jLabel39.setBounds(360, 70, 30, 23);

        SekunderTB.setHighlighter(null);
        SekunderTB.setName("SekunderTB"); // NOI18N
        SekunderTB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SekunderTBActionPerformed(evt);
            }
        });
        SekunderTB.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                SekunderTBKeyPressed(evt);
            }
        });
        internalFrame11.add(SekunderTB);
        SekunderTB.setBounds(390, 70, 55, 23);

        jLabel40.setText("BB :");
        jLabel40.setName("jLabel40"); // NOI18N
        internalFrame11.add(jLabel40);
        jLabel40.setBounds(460, 70, 30, 23);

        SekunderBB.setHighlighter(null);
        SekunderBB.setName("SekunderBB"); // NOI18N
        SekunderBB.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                SekunderBBKeyPressed(evt);
            }
        });
        internalFrame11.add(SekunderBB);
        SekunderBB.setBounds(490, 70, 55, 23);
        ...
        SekunderTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-07-2026 18:17:20" }));
        ...
        TanggalKunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-07-2026 18:17:20" }));
            ...
            if(TabTriase.getSelectedIndex()==0){
                ...
                if(PrimerKeluhanUtama.getText().trim().equals("")){
                    ...
                    if(Sequel.menyimpantf("data_triase_igd","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",15,new String[]{
                            ...
                            PrimerSaturasi.getText(),PrimerNyeri.getText(),PrimerTB.getText(),PrimerBB.getText()
                        })==true){
                ...
                if(SekunderAnamnesa.getText().trim().equals("")){
                    ...
                    if(Sequel.menyimpantf("data_triase_igd","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",15,new String[]{
                            ...
                            SekunderSaturasi.getText(),SekunderNyeri.getText(),SekunderTB.getText(),SekunderBB.getText()
                        })==true){
                    ...
                    try {
                        ...
                        for(i=0;i<tabMode.getRowCount();i++){  
                            ...
                            ps=koneksi.prepareStatement(
                                ...
                                "data_triase_igdprimer.plan,data_triase_igdprimer.tanggaltriase,data_triase_igdprimer.nik,data_triase_igd.bb,data_triase_igd.tb,data_triase_igd.tekanan_darah,"+
                            ...
                            try {
                                ...
                                if(rs.next()){
                                    htmlContent.append(
                                        ...
                                        "<td valign='top'> Suhu (C) : "+rs.getString("suhu")+", Respirasi(/menit) : "+rs.getString("pernapasan")+", Tensi : "+rs.getString("tekanan_darah")+" mmHg, Nadi(/menit) : "+rs.getString("nadi")+", Saturasi O²(%) : "+rs.getString("saturasi_o2")+", Nyeri : "+rs.getString("nyeri")+"</td>"
                                    );
                            ...
                            ps=koneksi.prepareStatement(
                                ...
                                "data_triase_igdsekunder.plan,data_triase_igdsekunder.tanggaltriase,data_triase_igdsekunder.nik,data_triase_igd.bb,data_triase_igd.tb,data_triase_igd.tekanan_darah,"+
                                "data_triase_igd.nadi,data_triase_igd.pernapasan,data_triase_igd.suhu,data_triase_igd.saturasi_o2,data_triase_igd.nyeri,"+
                    ...
                    try {
                        ...
                        try {
                            ...
                            if(rs.next()){
                                ...
                                // Tambahan dr Puri kebutuhan Klaim
                                PrimerTB.setText(rs.getString("tb"));
                                PrimerBB.setText(rs.getString("bb"));
                        ...
                        try {
                            ...
                            if(rs.next()){
                                ...
                                //Tambahan dr puri BB/TB
                                SekunderTB.setText(rs.getString("tb"));
                                SekunderBB.setText(rs.getString("bb"));
                ...
                if(LoadHTML.getText().contains("#AA0000")){
                    ...
                    try {
                        ps=koneksi.prepareStatement(
                            ...
                            "data_triase_igd.cara_masuk,data_triase_igd.alat_transportasi,master_triase_macam_kasus.macam_kasus from data_triase_igdprimer inner join data_triase_igd "+
                        ...
                        try {
                            ...
                            if(rs.next()){
                                ...
                                param.put("transportasi",rs.getString("alat_transportasi")==null?"-":rs.getString("alat_transportasi"));
                                ...
                                param.put("tandavital","Suhu : "+rs.getString("suhu")+" °C, Nyeri : "+rs.getString("nyeri")+", Tensi : "+rs.getString("tekanan_darah")+" mmHg, Nadi : "+rs.getString("nadi")+" /menit, Saturasi O² : "+rs.getString("saturasi_o2")+" %, Respirasi : "+rs.getString("pernapasan")+" /menit, TB : "+rs.getString("tb")+" cm, BB : "+rs.getString("bb")+" kg");
                    ...
                    try {
                        ps=koneksi.prepareStatement(
                            ...
                            "data_triase_igd.nadi,data_triase_igd.pernapasan,data_triase_igd.suhu,data_triase_igd.saturasi_o2,data_triase_igd.nyeri,"+
                            "data_triase_igd.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,pegawai.nama,data_triase_igd.tgl_kunjungan, "+
                            "data_triase_igd.cara_masuk,data_triase_igd.alat_transportasi,master_triase_macam_kasus.macam_kasus from data_triase_igdsekunder inner join data_triase_igd "+
                            "inner join pasien inner join pegawai inner join reg_periksa inner join master_triase_macam_kasus on "+
    ...
    private void PrimerTBKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PrimerTBKeyPressed
        Valid.pindah(evt, PrimerRespirasi, PrimerBB);
    }//GEN-LAST:event_PrimerTBKeyPressed

    private void PrimerBBKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PrimerBBKeyPressed
        Valid.pindah(evt, PrimerTB, PrimerKubutuhanKusus);
    }//GEN-LAST:event_PrimerBBKeyPressed

    private void SekunderTBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SekunderTBActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_SekunderTBActionPerformed

    private void SekunderTBKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SekunderTBKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_SekunderTBKeyPressed

    private void SekunderBBKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SekunderBBKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_SekunderBBKeyPressed
    ...
    */
    ...
    private widget.TextBox PrimerBB;
    ...
    private widget.TextBox PrimerTB;
    ...
    private widget.TextBox SekunderBB;
    ...
    private widget.TextBox SekunderTB;
    ...
    private void emptTeks(){
        ...
        PrimerTB.setText("");    // <--- TAMBAHKAN BARIS INI dr Puri
        PrimerBB.setText("");
        ...
        SekunderTB.setText("");    // <--- TAMBAHKAN BARIS INI
        SekunderBB.setText("");
    ...
    public void setNoRm(String norwt,String norm,String namapasien) {
        ...
        //  Tatalaksana.setText(Sequel.cariIsi("select rtl from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
            ...
            PrimerBB.setText(Sequel.cariIsi("select berat from pemeriksaan_ralan where no_rawat=?",TNoRw.getText())); 
            PrimerTB.setText(Sequel.cariIsi("select tinggi from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
            SekunderBB.setText(Sequel.cariIsi("select berat from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
            SekunderTB.setText(Sequel.cariIsi("select tinggi from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
                    ...
                    if(rs.next()){
                        ...
                        htmlContent.append(    
                            ...
                            "<tr class='isi'>"+
                                ...
                                "<td valign='middle'>Suhu (C) : "+rs.getString("suhu")+", Nyeri : "+rs.getString("nyeri")+", Tensi : "+rs.getString("tekanan_darah")+" mmHg, Nadi(/menit) : "+rs.getString("nadi")+", Saturasi O²(%) : "+rs.getString("saturasi_o2")+", Respirasi(/menit) : "+rs.getString("pernapasan")+", TB : "+rs.getString("tb")+" cm, BB : "+rs.getString("bb")+" kg</td>"+
                            "</tr>"+
                            "<tr class='isi'>"+
