...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    // §10 RANAP — Panel Hasil Lab toggle (default tersembunyi)
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        initComponents();
        initRawatInap();
        initPanelLabChangeListener(); // §10 RANAP — toggle panel hasil lab
    ...
    private void initComponents() {
        ...
        BtnVerifikasiSOAP = new widget.Button(); //<<-- Tambahan permintaan dr Puri
        BtnKoreksiRM = new widget.Button(); //<-- Tambahan Koreksi RM
        ...
        // Tambahan verifikasi SOAP/CPPT permintaan dr puri
        BtnVerifikasiSOAP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/accept.png"))); // NOI18N
        BtnVerifikasiSOAP.setMnemonic('V');
        BtnVerifikasiSOAP.setText("Verifikasi SOAP/CPPT");
        BtnVerifikasiSOAP.setToolTipText("Alt+V");
        BtnVerifikasiSOAP.setIconTextGap(3);
        BtnVerifikasiSOAP.setName("BtnVerifikasiSOAP"); // NOI18N
        BtnVerifikasiSOAP.setPreferredSize(new java.awt.Dimension(160, 30));
        BtnVerifikasiSOAP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnVerifikasiSOAPActionPerformed(evt);
            }
        });
        panelGlass8.add(BtnVerifikasiSOAP);
        
        BtnKoreksiRM.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/koreksiicon.png")));
        BtnKoreksiRM.setMnemonic('K');
        BtnKoreksiRM.setText("Koreksi RM");
        BtnKoreksiRM.setToolTipText("Alt+K - Pengajuan Koreksi Data Rekam Medis");
        BtnKoreksiRM.setIconTextGap(3);
        BtnKoreksiRM.setName("BtnKoreksiRM");
        BtnKoreksiRM.setPreferredSize(new java.awt.Dimension(160, 30));
        BtnKoreksiRM.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKoreksiRMActionPerformed(evt);
            }
        });
        panelGlass8.add(BtnKoreksiRM);
        ...
        // §10 RANAP — Tombol toggle panel hasil lab
        ...
        // §10 RANAP — Panel Hasil Lab embedded, default tersembunyi
    ...
    private void BtnVerifikasiSOAPActionPerformed(java.awt.event.ActionEvent evt) {
        if(TNoRw.getText().trim().equals("")){
            ...
            Object[] pilihan = {"Kondisi Stabil - Verifikasi Standar", "Ada Kendala/Keluhan Khusus", "Batal"};
            int jawab = JOptionPane.showOptionDialog(null,
                    "Bagaimana kondisi pasien untuk verifikasi SOAP/CPPT hari ini?",
                    "Verifikasi SOAP/CPPT",
                    JOptionPane.YES_NO_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE,
                    null, pilihan, pilihan[0]);

            if(jawab==0 || jawab==1){
                String objekVerifikasi =
                    "Telah di Verifikasi/konfirmasi kegiatan PPA selama 24 jam terakhir telah dilakukan.\n"+
                    "Review:\n"+
                    "- Catatan keperawatan ditelaah.\n"+
                    "- Catatan ahli gizi ditelaah.\n"+
                    "- Catatan farmasi klinis ditelaah.\n"+
                    "- Hasil laboratorium ditelaah.\n"+
                    "- Hasil radiologi ditelaah.\n"+
                    "- Terapi telah sesuai instruksi medis.\n"+
                    "- Tidak terdapat kendala koordinasi pelayanan.";

                String asesmenVerifikasi;
                String planVerifikasi;

                if(jawab==0){
                    asesmenVerifikasi =
                        "Kondisi pasien membaik.\n"+
                        "Pelayanan multidisiplin berjalan sesuai rencana.";
                    planVerifikasi =
                        "Lanjutkan terapi.\n"+
                        "Lanjutkan intervensi keperawatan.\n"+
                        "Lanjutkan intervensi gizi.\n"+
                        "Monitoring perkembangan klinis.";
                }else{
                    String catatanDokter = JOptionPane.showInputDialog(null,
                            "Silahkan tulis catatan singkat mengenai kendala/keluhan pasien:",
                            "Catatan Kendala/Keluhan",
                            JOptionPane.PLAIN_MESSAGE);
                    if(catatanDokter==null || catatanDokter.trim().equals("")){
                        JOptionPane.showMessageDialog(null,"Verifikasi dibatalkan, catatan tidak boleh kosong untuk kondisi ini..!!");
                        return;
                    }
                    asesmenVerifikasi =
                        "Kondisi pasien belum optimal / masih terdapat keluhan.\n"+
                        "Catatan: "+catatanDokter.trim();
                    planVerifikasi =
                        "Evaluasi dan tindak lanjut lebih intensif diperlukan.\n"+
                        "Koordinasi ulang dengan PPA terkait sesuai kebutuhan.\n"+
                        catatanDokter.trim();
                }

                int konfirmasi = JOptionPane.showConfirmDialog(null,
                        "Yakin akan memverifikasi SOAP/CPPT pasien ini untuk hari ini?",
                        "Konfirmasi Verifikasi SOAP/CPPT",
                        JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);

                if(konfirmasi==JOptionPane.YES_OPTION){
                    String kdDokterVerifikasi = akses.getkode();
                    String namaDokterVerifikasi = Sequel.cariIsi("select nama from pegawai where nik=?", kdDokterVerifikasi);
                    boolean nipAdaDiPegawaiSOAP = (namaDokterVerifikasi!=null && !namaDokterVerifikasi.trim().equals(""));
                    if(!nipAdaDiPegawaiSOAP){
                        namaDokterVerifikasi = Sequel.cariIsi("select nm_dokter from dokter where kd_dokter=?", kdDokterVerifikasi);
                    }
                    if(namaDokterVerifikasi==null||namaDokterVerifikasi.trim().equals("")){
                        namaDokterVerifikasi = kdDokterVerifikasi;
                    }
                    // Jika user tidak terdaftar di pegawai, nip harus kosong (FK constraint)
                    // Identitas disimpan di dalam teks objekVerifikasi
                    String nipInsertSOAP = nipAdaDiPegawaiSOAP ? kdDokterVerifikasi : "";
                    String objekVerifikasiDenganPetugas = objekVerifikasi +
                            (nipAdaDiPegawaiSOAP ? "" : "\n- Diverifikasi oleh: "+namaDokterVerifikasi+" ("+kdDokterVerifikasi+")");

                    java.util.Calendar cal = java.util.Calendar.getInstance();
                    String jamSekarang = String.format("%02d:%02d:%02d",
                            cal.get(java.util.Calendar.HOUR_OF_DAY), cal.get(java.util.Calendar.MINUTE), cal.get(java.util.Calendar.SECOND));
                    String tglSekarang = new java.text.SimpleDateFormat("yyyy-MM-dd").format(new Date());

                    if(Sequel.menyimpantf("pemeriksaan_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",20,new String[]{
                            TNoRw.getText(),tglSekarang,jamSekarang,
                            "","","","","","","","","Compos Mentis",
                            "",objekVerifikasiDenganPetugas,"",
                            asesmenVerifikasi,planVerifikasi,"","",
                            nipInsertSOAP
                        })==true){
                        tabModePemeriksaan.addRow(new Object[]{
                            false,TNoRw.getText(),TNoRM.getText(),TPasien.getText(),tglSekarang,jamSekarang,
                            "","","","","","","","","Compos Mentis",
                            "",objekVerifikasiDenganPetugas,"",asesmenVerifikasi,planVerifikasi,"","",
                            nipInsertSOAP,namaDokterVerifikasi,"Dokter/DPJP"
                        });
                        LCount.setText(""+tabModePemeriksaan.getRowCount());
                        JOptionPane.showMessageDialog(null,"Verifikasi SOAP/CPPT berhasil disimpan.");
                    }else{
                        JOptionPane.showMessageDialog(null,"Gagal menyimpan verifikasi SOAP/CPPT.");
                    }
                }
            }
        }
    ...
    private void BtnKoreksiRMActionPerformed(java.awt.event.ActionEvent evt) {
    if (TNoRw.getText().trim().isEmpty()) {
        JOptionPane.showMessageDialog(null, "Pilih pasien terlebih dahulu!");
        return;
    }
    new rekammedis.RMKoreksiRM(null, true,
        TNoRw.getText().trim(),
        TNoRM.getText().trim(),
    ...
    //<<-- Tambahan permintaan dr Puri
    // BtnSBAR dihapus — fitur SBAR tidak digunakan
    ...
    private void tbRawatDrMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbRawatDrMouseClicked
        ...
        // §10 RANAP — refresh lab jika panel terbuka
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    */
    ...
    private widget.Button BtnVerifikasiSOAP; //<-- Tambahan verifikasi SOAP/CPPT
    private widget.Button BtnKoreksiRM; //<-- Tambahan Koreksi RM
    ...
    /** §10 RANAP — Change listener TabRawat: refresh lab saat tab Pemeriksaan dibuka */
    ...
    /** §10 RANAP — Toggle tampil/sembunyikan panel hasil lab */
    ...
    /** §10 RANAP — Muat hasil lab dari DB di background thread */
    private void muatHasilLab(String noRM) {
        ...
        new Thread(() -> {
            try {
                String sql =
                "SELECT dpl.tgl_periksa, dpl.jam, tl.Pemeriksaan, " +
                ...
                while (rsLab.next()) {
                    ...
                    String nama    = rsLab.getString("pemeriksaan");
                ...
                System.out.println("muatHasilLab RANAP error: " + ex);
            }
        }).start();
    }
                    ...
                    if(KdPeg.getText().trim().equals("")||TPegawai.getText().trim().equals("")){
                        ...
                        if(akses.getkode().equals("Admin Utama")){
                            if(Sequel.menyimpantf("pemeriksaan_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",20,new String[]{
                                ...
                                LCount.setText(""+tabModePemeriksaan.getRowCount());
                                if (panelLabSamping != null && panelLabSamping.isVisible()) muatHasilLab(TNoRM.getText()); // §10 RANAP
                                BtnBatalActionPerformed(null);
                            }
                        }else{
