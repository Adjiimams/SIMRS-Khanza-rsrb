...
import rekammedis.RMHasilLaboratorium;
...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    // ==== Pendukung fitur cek Potensi PRB (Program Rujuk Balik) BPJS ====
    private final ApiBPJS apiPRB = new ApiBPJS();
    private final ObjectMapper mapperPRB = new ObjectMapper();
    private String linkPRB = "";
    // §10 — Panel Hasil Lab toggle (default tersembunyi)
    private javax.swing.JPanel panelLabSamping;
    private javax.swing.JTable tblHasilLab;
    private javax.swing.table.DefaultTableModel modelHasilLab;
    private javax.swing.JLabel lblLabHeader;
    private javax.swing.JLabel lblPRBWarning;
    private widget.Button BtnToggleLab;
    ...
    public DlgRawatJalan(java.awt.Frame parent, boolean modal) {
        ...
        initComponents();
        initRawatJalan();
        initPanelLabChangeListener(); // §10 — toggle panel hasil lab
    ...
    private void initComponents() {
        ...
        // §10 — Tombol toggle panel hasil lab (ganti BtnHasilLab)
        BtnToggleLab = new widget.Button();
        BtnToggleLab.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Search-16x16.png")));
        BtnToggleLab.setText("Hasil Lab");
        BtnToggleLab.setToolTipText("Tampilkan/Sembunyikan Hasil Lab");
        BtnToggleLab.setName("BtnToggleLab");
        BtnToggleLab.setPreferredSize(new java.awt.Dimension(110, 30));
        BtnToggleLab.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnToggleLabActionPerformed(evt);
            }
        });
        panelGlass8.add(BtnToggleLab);
        ...
        // §10 — Panel Hasil Lab embedded di area kosong kanan (x=910, lebar 400px)
        // Default TIDAK TAMPIL — muncul saat BtnToggleLab diklik
        panelLabSamping = new javax.swing.JPanel(new java.awt.BorderLayout(0, 2));
        panelLabSamping.setBackground(new java.awt.Color(240, 253, 250));
        panelLabSamping.setBorder(javax.swing.BorderFactory.createCompoundBorder(
            javax.swing.BorderFactory.createLineBorder(new java.awt.Color(5, 150, 105)),
            javax.swing.BorderFactory.createEmptyBorder(3, 4, 3, 4)
        ));

        lblLabHeader = new javax.swing.JLabel("Hasil Lab Pasien");
        lblLabHeader.setFont(new java.awt.Font("Tahoma", java.awt.Font.BOLD, 10));
        lblLabHeader.setForeground(new java.awt.Color(5, 150, 105));
        panelLabSamping.add(lblLabHeader, java.awt.BorderLayout.NORTH);

        lblPRBWarning = new javax.swing.JLabel(" ");
        lblPRBWarning.setFont(new java.awt.Font("Tahoma", java.awt.Font.BOLD, 9));
        lblPRBWarning.setForeground(java.awt.Color.WHITE);
        lblPRBWarning.setBackground(new java.awt.Color(220, 38, 38));
        lblPRBWarning.setOpaque(true);
        lblPRBWarning.setBorder(javax.swing.BorderFactory.createEmptyBorder(2, 4, 2, 4));
        lblPRBWarning.setVisible(false);
        panelLabSamping.add(lblPRBWarning, java.awt.BorderLayout.SOUTH);

        modelHasilLab = new javax.swing.table.DefaultTableModel(
            new String[]{"Tanggal", "Pemeriksaan", "Hasil", "Rujukan"}, 0) {
            @Override public boolean isCellEditable(int r, int c) { return false; }
        };
        tblHasilLab = new javax.swing.JTable(modelHasilLab);
        tblHasilLab.setFont(new java.awt.Font("Tahoma", java.awt.Font.PLAIN, 10));
        tblHasilLab.getTableHeader().setFont(new java.awt.Font("Tahoma", java.awt.Font.BOLD, 10));
        tblHasilLab.getTableHeader().setBackground(new java.awt.Color(5, 150, 105));
        tblHasilLab.getTableHeader().setForeground(java.awt.Color.WHITE);
        tblHasilLab.setRowHeight(19);
        tblHasilLab.setGridColor(new java.awt.Color(209, 250, 229));
        tblHasilLab.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        tblHasilLab.getColumnModel().getColumn(0).setPreferredWidth(70);
        tblHasilLab.getColumnModel().getColumn(1).setPreferredWidth(140);
        tblHasilLab.getColumnModel().getColumn(2).setPreferredWidth(70);
        tblHasilLab.getColumnModel().getColumn(3).setPreferredWidth(100);
        tblHasilLab.setDefaultRenderer(Object.class, new javax.swing.table.DefaultTableCellRenderer() {
            @Override
            public java.awt.Component getTableCellRendererComponent(
                ...
                if (!isSelected) {
                    String h = table.getModel().getValueAt(row, 2) == null ? ""
                               : table.getModel().getValueAt(row, 2).toString();
                    if (h.contains("(H)") || h.contains("(L)")) {
                        setBackground(new java.awt.Color(254, 226, 226));
                        setForeground(new java.awt.Color(185, 28, 28));
                        setFont(getFont().deriveFont(java.awt.Font.BOLD));
                    } else {
                        setBackground(row % 2 == 0 ? java.awt.Color.WHITE
                                                   : new java.awt.Color(236, 253, 245));
        ...
        javax.swing.JScrollPane scrollLab = new javax.swing.JScrollPane(tblHasilLab);
        scrollLab.setBorder(null);
        panelLabSamping.add(scrollLab, java.awt.BorderLayout.CENTER);

        panelGlass12.add(panelLabSamping);
        panelLabSamping.setBounds(910, 30, 400, 215);
        panelLabSamping.setVisible(false); // default tersembunyi
    ...
    private void BtnHasilLabActionPerformed(java.awt.event.ActionEvent evt) {
        if(TNoRw.getText().trim().equals("")){
            ...
            RMHasilLaboratorium dlgHasilLab = new RMHasilLaboratorium(null, false, TNoRw.getText(), TPasien.getText());
            dlgHasilLab.setVisible(true);
        }
    }
    ...
    private void tbRawatDrMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbRawatDrMouseClicked
        ...
        // §10 — cek PRB lokal + refresh lab jika panel terbuka
        cekPRBLokal(TNoRw.getText());
        if (panelLabSamping != null && panelLabSamping.isVisible() && !TNoRM.getText().trim().isEmpty())
            muatHasilLab(TNoRM.getText().trim());
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    */
    ...
    // ── PATCH PRB LOKAL ────────────────────────────────────────
    // Cek PRB dari DB lokal, tampilkan popup keputusan dokter.
    // Chain utama  : no_rawat → bridging_sep → bpjs_prb
    // Chain fallback: pasien.no_peserta → bridging_sep.no_kartu → bpjs_prb
    private void cekPRBLokal(String noRawat) {
        if (noRawat == null || noRawat.trim().isEmpty()) return;
        ExecutorService exec = Executors.newSingleThreadExecutor();
        exec.submit(() -> {
            try {
                // Chain utama
                String kodePRB = Sequel.cariIsi(
                    "SELECT bpjs_prb.prb FROM bpjs_prb " +
                    "INNER JOIN bridging_sep ON bpjs_prb.no_sep = bridging_sep.no_sep " +
                    "WHERE bridging_sep.no_rawat = ?",
                    noRawat.trim()
                );
                // Chain fallback
                if (kodePRB == null || kodePRB.trim().isEmpty()) {
                    String noRM = TNoRM.getText().trim();
                    if (!noRM.isEmpty()) {
                        String noPeserta = Sequel.cariIsi(
                            "SELECT no_peserta FROM pasien WHERE no_rkm_medis = ?", noRM
                        );
                        if (noPeserta != null && !noPeserta.trim().isEmpty()) {
                            kodePRB = Sequel.cariIsi(
                                "SELECT bpjs_prb.prb FROM bpjs_prb " +
                                "INNER JOIN bridging_sep ON bpjs_prb.no_sep = bridging_sep.no_sep " +
                                "WHERE bridging_sep.no_kartu = ? " +
                ...
                if (kodePRB == null || kodePRB.trim().isEmpty()) return;
                final String statusPRB = kodePRB.trim();

                SwingUtilities.invokeLater(() -> {
                    tampilPopupPRB(noRawat.trim(), statusPRB);
                });
            } catch (Exception e) {
                System.out.println("cekPRBLokal error: " + e);
            }
        });
        exec.shutdown();
    }

    // ── Dialog keputusan PRB ───────────────────────────────────
    private void tampilPopupPRB(String noRawat, String statusPRB) {
        // Panel utama popup
        javax.swing.JPanel panel = new javax.swing.JPanel();
        panel.setLayout(new java.awt.BorderLayout(0, 10));

        // Header merah
        javax.swing.JLabel lblHeader = new javax.swing.JLabel(
            "<html><b>Pasien ini terdaftar dalam Program Rujuk Balik (PRB).</b></html>"
        );
        lblHeader.setForeground(new java.awt.Color(180, 0, 0));
        lblHeader.setFont(lblHeader.getFont().deriveFont(13f));

        // Info pasien
        javax.swing.JLabel lblInfo = new javax.swing.JLabel(
            "<html>" +
            "Status&nbsp;&nbsp;: <b>" + statusPRB + "</b><br>" +
            "Pasien&nbsp;&nbsp;: <b>" + TPasien.getText() + "</b><br>" +
            "No. RM : <b>" + TNoRM.getText() + "</b>" +
            "</html>"
        );
        lblInfo.setFont(lblInfo.getFont().deriveFont(12f));

        javax.swing.JLabel lblPertanyaan = new javax.swing.JLabel(
            "<html><br>Apakah pasien dapat diteruskan ke FKTP?</html>"
        );
        lblPertanyaan.setFont(lblPertanyaan.getFont().deriveFont(12f));

        javax.swing.JPanel panelTeks = new javax.swing.JPanel();
        panelTeks.setLayout(new javax.swing.BoxLayout(panelTeks, javax.swing.BoxLayout.Y_AXIS));
        panelTeks.add(lblHeader);
        panelTeks.add(javax.swing.Box.createVerticalStrut(8));
        panelTeks.add(lblInfo);
        panelTeks.add(lblPertanyaan);

        panel.add(panelTeks, java.awt.BorderLayout.CENTER);

        // Tombol pilihan
        Object[] tombol = {
            "✓ Ya, Lanjutkan ke FKTP",
            "✗ Tunda — Perlu Perawatan Lanjut RS"
        };
        ...
        if (pilihan == JOptionPane.NO_OPTION) {
            // Dokter pilih TUNDA — tampilkan dialog alasan
            tampilDialogAlasanPRB(noRawat, statusPRB);
        }
        // Pilihan Ya / tutup → tidak ada aksi, dokter lanjut normal
    }

    // ── Dialog isi alasan penundaan PRB ───────────────────────
    private void tampilDialogAlasanPRB(String noRawat, String statusPRB) {
        javax.swing.JDialog dlg = new javax.swing.JDialog(
            (java.awt.Frame) javax.swing.SwingUtilities.getWindowAncestor(DlgRawatJalan.this),
            "Alasan Penundaan PRB", true
        );
        dlg.setSize(480, 340);
        dlg.setLocationRelativeTo(DlgRawatJalan.this);
        dlg.setLayout(new java.awt.BorderLayout(10, 10));

        // Panel atas — info
        javax.swing.JLabel lblJudul = new javax.swing.JLabel(
            "<html><b>Penundaan Rujuk Balik ke FKTP</b><br>" +
            "<span style='color:gray'>Pasien: " + TPasien.getText() +
            " | No.RM: " + TNoRM.getText() + "</span></html>"
        );
        lblJudul.setBorder(javax.swing.BorderFactory.createEmptyBorder(12, 14, 4, 14));

        // Panel tengah — textarea alasan
        javax.swing.JPanel panelTengah = new javax.swing.JPanel(new java.awt.BorderLayout(6, 6));
        panelTengah.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 14, 0, 14));

        javax.swing.JLabel lblAlasan = new javax.swing.JLabel(
            "Alasan medis pasien belum dapat diteruskan ke FKTP:"
        );

        javax.swing.JTextArea txtAlasan = new javax.swing.JTextArea(6, 30);
        txtAlasan.setLineWrap(true);
        txtAlasan.setWrapStyleWord(true);
        txtAlasan.setFont(new java.awt.Font("Arial", java.awt.Font.PLAIN, 12));
        txtAlasan.setBorder(javax.swing.BorderFactory.createCompoundBorder(
            javax.swing.BorderFactory.createLineBorder(java.awt.Color.GRAY),
            javax.swing.BorderFactory.createEmptyBorder(4, 6, 4, 6)
        ));
        javax.swing.JScrollPane scroll = new javax.swing.JScrollPane(txtAlasan);

        panelTengah.add(lblAlasan, java.awt.BorderLayout.NORTH);
        panelTengah.add(scroll, java.awt.BorderLayout.CENTER);

        // Panel bawah — tombol
        javax.swing.JPanel panelBawah = new javax.swing.JPanel(new java.awt.FlowLayout(java.awt.FlowLayout.RIGHT, 10, 10));

        javax.swing.JButton btnSimpan = new javax.swing.JButton("Simpan & Cetak Surat");
        btnSimpan.setBackground(new java.awt.Color(220, 38, 38));
        btnSimpan.setForeground(java.awt.Color.WHITE);
        btnSimpan.setFont(btnSimpan.getFont().deriveFont(java.awt.Font.BOLD));
        ...
        btnSimpan.addActionListener(e -> {
            ...
            if (alasan.isEmpty()) {
                JOptionPane.showMessageDialog(dlg,
                    "Alasan penundaan wajib diisi.", "Perhatian",
                    JOptionPane.WARNING_MESSAGE);
                return;
            }
            // Simpan ke tabel tunda_prb
            try {
                String tglSekarang = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
                    .format(new java.util.Date());
                String kdDokterSimpan = KdDok.getText().trim();
                ...
                if (berhasil) {
                    dlg.dispose();
                    cetakSuratTundaPRB(noRawat, statusPRB, alasan, tglSekarang);
                } else {
                    JOptionPane.showMessageDialog(dlg,
                        "Gagal menyimpan data penundaan PRB.", "Error",
                        JOptionPane.ERROR_MESSAGE);
                }
            } catch (Exception ex) {
                System.out.println("simpanTundaPRB error: " + ex);
                JOptionPane.showMessageDialog(dlg,
        ...
        dlg.add(lblJudul, java.awt.BorderLayout.NORTH);
        dlg.add(panelTengah, java.awt.BorderLayout.CENTER);
        dlg.add(panelBawah, java.awt.BorderLayout.SOUTH);
        dlg.setVisible(true);
    }

    // ── Cetak surat keterangan penundaan PRB ke BPJS ──────────
    private void cetakSuratTundaPRB(String noRawat, String statusPRB,
                                     String alasan, String tglTunda) {
        try {
            // Ambil data dokter
            String nmDokter = Sequel.cariIsi(
                "SELECT nm_dokter FROM dokter WHERE kd_dokter = ?",
                KdDok.getText().trim()
            );
            // Ambil nama & alamat instansi via PreparedStatement langsung
            String namaInstansi  = "RS RAFFLESIA";
            String alamatInstansi = "";
            try {
                java.sql.PreparedStatement psInst = koneksi.prepareStatement(
                    "SELECT nama_instansi, alamat FROM set_instansi LIMIT 1"
                );
                java.sql.ResultSet rsInst = psInst.executeQuery();
                if (rsInst.next()) {
                    namaInstansi  = rsInst.getString("nama_instansi");
                    alamatInstansi = rsInst.getString("alamat");
                }
                rsInst.close(); psInst.close();
            } catch (Exception exInst) {
                System.out.println("ambilInstansi error: " + exInst);
            }

            String tglCetak = new java.text.SimpleDateFormat("dd MMMM yyyy",
                new java.util.Locale("id", "ID")).format(new java.util.Date());
            String tglTundaFormat = tglTunda.substring(0, 10)
                .replace("-", "/");
            ...
            String html =
                ...
                "  .kop h2{font-size:15px;text-transform:uppercase;margin:2px 0;}" +
                "  .kop h3{font-size:12px;font-weight:normal;margin:2px 0;}" +
                "  .judul{text-align:center;margin:16px 0 6px;font-size:14px;font-weight:bold;text-decoration:underline;text-transform:uppercase;letter-spacing:1px;}" +
                "  table.data td{padding:4px 8px;font-size:12px;}" +
                "  table.data td:first-child{width:38%;}" +
                "  .box{border:1px solid #c0392b;background:#fff5f5;border-radius:4px;padding:10px 14px;margin:14px 0;font-size:12px;line-height:1.7;}" +
                "  .ttd{margin-top:36px;text-align:right;width:100%;}" +
                "  .ttd .garis{margin-top:52px;border-top:1px solid #000;width:200px;margin-left:auto;}" +
                "  @media print{body{margin:20px;} .no-print{display:none;}}" +
                "</style></head><body>" +

                // Tombol cetak
                "<div class='no-print' style='margin-bottom:14px;text-align:right;'>" +
                "<button onclick='window.print()' style='background:#c0392b;color:#fff;border:none;padding:8px 20px;border-radius:4px;cursor:pointer;font-size:13px;'>&#128438; Cetak</button>" +
                "<button onclick='window.close()' style='background:#777;color:#fff;border:none;padding:8px 16px;border-radius:4px;cursor:pointer;font-size:13px;margin-left:8px;'>Tutup</button>" +
                "</div>" +

                // Kop surat
                "<div class='kop'>" +
                "<h2>" + (namaInstansi != null ? namaInstansi : "RS RAFFLESIA") + "</h2>" +
                "<h3>" + (alamatInstansi != null ? alamatInstansi : "") + "</h3>" +
                "</div>" +

                // Judul
                "<div class='judul'>Surat Keterangan Penundaan Program Rujuk Balik (PRB)</div>" +
                "<div style='text-align:center;font-size:11px;color:#555;margin-bottom:14px;'>Kepada Yth. BPJS Kesehatan</div>" +

                // Data
                "<table class='data' width='100%'>" +
                "<tr><td>No. Rawat</td><td>: <b>" + noRawat + "</b></td></tr>" +
                "<tr><td>No. RM</td><td>: " + TNoRM.getText() + "</td></tr>" +
                "<tr><td>Nama Pasien</td><td>: <b>" + TPasien.getText() + "</b></td></tr>" +
                "<tr><td>Status PRB</td><td>: " + statusPRB + "</td></tr>" +
                "<tr><td>Tanggal</td><td>: " + tglTundaFormat + "</td></tr>" +
                "<tr><td>Dokter Pemeriksa</td><td>: " + (nmDokter != null ? nmDokter : KdDok.getText()) + "</td></tr>" +
                "</table>" +

                // Kotak alasan
                "<div class='box'>" +
                "<b>Alasan Penundaan Rujuk Balik ke FKTP:</b><br><br>" +
                alasan.replace("\n", "<br>") +
                "</div>" +

                // Penutup
                "<p style='font-size:12px;line-height:1.7;margin-top:10px;'>" +
                "Berdasarkan pemeriksaan klinis, pasien tersebut di atas belum dapat " +
                "diteruskan ke Fasilitas Kesehatan Tingkat Pertama (FKTP) dikarenakan " +
                "alasan medis sebagaimana tercantum di atas. Pasien masih memerlukan " +
                "penanganan dan pemantauan lebih lanjut di tingkat rumah sakit." +
                "</p>" +

                // TTD
                "<div class='ttd'>" +
                (namaInstansi != null ? namaInstansi : "RS RAFFLESIA") + ", " + tglCetak + "<br><br>" +
                "Dokter Pemeriksa,<br>" +
                "<div class='garis'></div>" +
                "<b>" + (nmDokter != null ? nmDokter : "") + "</b>" +
                "</div>" +

                "</body></html>";

            // Simpan ke file temp dan buka di browser default
            java.io.File fileSurat = java.io.File.createTempFile("SuratTundaPRB_", ".html");
            fileSurat.deleteOnExit();
            java.io.FileWriter fw = new java.io.FileWriter(fileSurat);
            fw.write(html);
            fw.close();
            java.awt.Desktop.getDesktop().browse(fileSurat.toURI());

        } catch (Exception ex) {
            System.out.println("cetakSuratTundaPRB error: " + ex);
            JOptionPane.showMessageDialog(DlgRawatJalan.this,
                "Gagal membuka surat cetak: " + ex.getMessage(),
                "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    // ── AKHIR PATCH PRB LOKAL ──────────────────────────────────
    ...
    private void isRawat(){
        ...
        cekPRBLokal(TNoRw.getText()); // ← PATCH PRB: cek otomatis saat data pasien di-load
    }
    ...
    /** §10 — Change listener TabRawat: refresh lab saat tab Pemeriksaan dibuka (hanya kalau panel visible) */
    private void initPanelLabChangeListener() {
        TabRawat.addChangeListener(e -> {
            if (TabRawat.getSelectedIndex() == 3
                    && panelLabSamping != null && panelLabSamping.isVisible()
                    && !TNoRM.getText().trim().isEmpty()) {
                muatHasilLab(TNoRM.getText().trim());
            }
        });
    }

    /** §10 — Toggle tampil/sembunyikan panel hasil lab */
    private void BtnToggleLabActionPerformed(java.awt.event.ActionEvent evt) {
        if (panelLabSamping == null) return;
        boolean tampil = !panelLabSamping.isVisible();
        panelLabSamping.setVisible(tampil);
        if (tampil && !TNoRM.getText().trim().isEmpty()) {
            muatHasilLab(TNoRM.getText().trim());
        }
        BtnToggleLab.setText(tampil ? "▼ Hasil Lab" : "Hasil Lab");
    }

    /** §10 — Muat hasil lab dari DB di background thread */
    private void muatHasilLab(String noRM) {
        if (noRM == null || noRM.trim().isEmpty()) {
            if (modelHasilLab != null) modelHasilLab.setRowCount(0);
            if (lblLabHeader != null) lblLabHeader.setText("Hasil Lab Pasien");
            return;
        }
        if (lblLabHeader != null) lblLabHeader.setText("Memuat...");
        new Thread(() -> {
            try {
                // Query menggunakan tabel yang sama dengan RMHasilLaboratorium.java
                // detail_periksa_lab JOIN jns_perawatan_lab, filter via reg_periksa (no_rkm_medis)
                String sql =
                    "SELECT dpl.tgl_periksa, dpl.jam, jpl.nm_perawatan, " +
                    "       dpl.nilai, dpl.nilai_rujukan " +
                    "FROM detail_periksa_lab dpl " +
                    "INNER JOIN jns_perawatan_lab jpl ON dpl.kd_jenis_prw = jpl.kd_jenis_prw " +
                    "INNER JOIN reg_periksa rp ON dpl.no_rawat = rp.no_rawat " +
                    "WHERE rp.no_rkm_medis = ? " +
                    "  AND dpl.tgl_periksa >= DATE_SUB(CURDATE(), INTERVAL 90 DAY) " +
                    "ORDER BY dpl.tgl_periksa DESC, dpl.jam DESC, jpl.nm_perawatan ASC " +
                    "LIMIT 200";
                PreparedStatement psLab = koneksi.prepareStatement(sql);
                psLab.setString(1, noRM.trim());
                ResultSet rsLab = psLab.executeQuery();
                java.util.List<Object[]> rows = new java.util.ArrayList<>();
                while (rsLab.next()) {
                    String tgl     = rsLab.getString("tgl_periksa");
                    String jam     = rsLab.getString("jam");
                    String nama    = rsLab.getString("nm_perawatan");
                    String nilai   = rsLab.getString("nilai");
                    String rujukan = rsLab.getString("nilai_rujukan");

                    // Tandai nilai abnormal (H)/(L) berdasarkan nilai_rujukan
                    String nilaiTampil = nilai == null ? "-" : nilai;
                    try {
                        if (rujukan != null && !rujukan.trim().isEmpty() && nilai != null) {
                            String[] parts = rujukan.trim().split("-");
                            if (parts.length == 2) {
                                double val = Double.parseDouble(nilai.replaceAll("[^0-9.]", "").trim());
                                double min = Double.parseDouble(parts[0].trim());
                                double max = Double.parseDouble(parts[1].trim());
                                if      (val < min) nilaiTampil = nilai + " (L)";
                                else if (val > max) nilaiTampil = nilai + " (H)";
                            }
                        }
                    } catch (NumberFormatException ignored) {}

                    // Kolom Tanggal gabung Jam untuk ringkas
                    String tglJam = (tgl != null ? tgl : "-") + (jam != null ? " " + jam : "");
                    rows.add(new Object[]{ tglJam, nama, nilaiTampil, rujukan != null ? rujukan : "-" });
                }
                rsLab.close(); psLab.close();
                final java.util.List<Object[]> finalRows = rows;
                javax.swing.SwingUtilities.invokeLater(() -> {
                    if (modelHasilLab == null) return;
                    modelHasilLab.setRowCount(0);
                    for (Object[] row : finalRows) modelHasilLab.addRow(row);
                    if (lblLabHeader != null)
                        lblLabHeader.setText("Hasil Lab (" + finalRows.size() + " item, 90 hari)");
                });
            } catch (Exception ex) {
                javax.swing.SwingUtilities.invokeLater(() -> {
                    if (lblLabHeader != null) lblLabHeader.setText("Hasil Lab — gagal memuat");
                });
                System.out.println("muatHasilLab error: " + ex);
            }
        }).start();
    }
    ...
    private void initRawatJalan(){
        ...
        BtnPermintaanKonsultasiPerawat.setText("Konsultasi SBAR");
    ...
    /**
     * Cek Potensi PRB (Program Rujuk Balik) BPJS untuk pasien yang sedang diperiksa.
     * API BPJS "prbpotensi" berbasis daftar bulanan (bukan per No.Kartu), jadi dicek
     * bulan berjalan + 2 bulan ke belakang untuk berjaga-jaga. Kalau No.Kartu pasien
     * ditemukan di salah satu daftar itu, tampilkan warning.
     * Gagal-aman: kalau API BPJS error/timeout, cukup dicatat di console,
     * TIDAK mengganggu/membatalkan proses simpan SOAP/CPPT yang sudah selesai.
     */
    // cekPotensiPRB (API BPJS) dihapus — diganti cekPRBLokal (DB lokal, tanpa delay)
                        ...
                        if(akses.getkode().equals("Admin Utama")){
                            if(Sequel.menyimpantf("pemeriksaan_ralan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",21,new String[]{
                                ...
                                LingkarPerut.getText(),TindakLanjut.getText(),TPenilaian.getText(),TInstruksi.getText(),TEvaluasi.getText(),KdPeg.getText()})==true){
                                    ...
                                    LCount.setText(""+tabModePemeriksaan.getRowCount());
                                    if (panelLabSamping != null && panelLabSamping.isVisible()) muatHasilLab(TNoRM.getText()); // §10
                            }
                        }else{
