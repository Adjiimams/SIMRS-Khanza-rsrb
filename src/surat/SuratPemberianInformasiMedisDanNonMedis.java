 ...
 */
public final class SuratPemberianInformasiMedisDanNonMedis extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SuratPemberianInformasiMedisDanNonMedis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Jenis Informasi","Label 1","Label 2","Label 3","Label 4","Label 5","Label 6","Label 7","Label 8","Label 9","Label 10","Label 11"
        }){
          @Override 
    ...
    private void initComponents() {
        ...
        JenisInformasi = new widget.ComboBox();
        jLabelJenisInformasi = new widget.Label();
        LabelKustom1 = new widget.TextBox();
        LabelKustom2 = new widget.TextBox();
        LabelKustom3 = new widget.TextBox();
        LabelKustom4 = new widget.TextBox();
        LabelKustom5 = new widget.TextBox();
        LabelKustom6 = new widget.TextBox();
        LabelKustom7 = new widget.TextBox();
        LabelKustom8 = new widget.TextBox();
        LabelKustom9 = new widget.TextBox();
        LabelKustom10 = new widget.TextBox();
        LabelKustom11 = new widget.TextBox();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Pemberian Informasi Medis dan Non Medis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabelJenisInformasi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabelJenisInformasi.setText("Jenis Informasi :");
        jLabelJenisInformasi.setName("jLabelJenisInformasi"); // NOI18N
        FormInput.add(jLabelJenisInformasi);
        jLabelJenisInformasi.setBounds(600, 70, 100, 23);

        JenisInformasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Medis", "Non Medis" }));
        JenisInformasi.setName("JenisInformasi"); // NOI18N
        JenisInformasi.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                JenisInformasiItemStateChanged(evt);
            }
        });
        FormInput.add(JenisInformasi);
        JenisInformasi.setBounds(704, 70, 150, 23);
        ...
        LabelKustom1.setName("LabelKustom1"); // NOI18N
        LabelKustom1.setVisible(false);
        FormInput.add(LabelKustom1);
        LabelKustom1.setBounds(44, 90, 150, 23);
        ...
        LabelKustom2.setName("LabelKustom2"); // NOI18N
        LabelKustom2.setVisible(false);
        FormInput.add(LabelKustom2);
        LabelKustom2.setBounds(454, 90, 150, 23);
        ...
        LabelKustom4.setName("LabelKustom4"); // NOI18N
        LabelKustom4.setVisible(false);
        FormInput.add(LabelKustom4);
        LabelKustom4.setBounds(454, 160, 150, 23);
        ...
        LabelKustom3.setName("LabelKustom3"); // NOI18N
        LabelKustom3.setVisible(false);
        FormInput.add(LabelKustom3);
        LabelKustom3.setBounds(44, 160, 150, 23);
        ...
        LabelKustom6.setName("LabelKustom6"); // NOI18N
        LabelKustom6.setVisible(false);
        FormInput.add(LabelKustom6);
        LabelKustom6.setBounds(454, 230, 150, 23);
        ...
        LabelKustom5.setName("LabelKustom5"); // NOI18N
        LabelKustom5.setVisible(false);
        FormInput.add(LabelKustom5);
        LabelKustom5.setBounds(44, 230, 150, 23);
        ...
        LabelKustom8.setName("LabelKustom8"); // NOI18N
        LabelKustom8.setVisible(false);
        FormInput.add(LabelKustom8);
        LabelKustom8.setBounds(454, 300, 150, 23);
        ...
        LabelKustom7.setName("LabelKustom7"); // NOI18N
        LabelKustom7.setVisible(false);
        FormInput.add(LabelKustom7);
        LabelKustom7.setBounds(44, 300, 150, 23);
        ...
        LabelKustom10.setName("LabelKustom10"); // NOI18N
        LabelKustom10.setVisible(false);
        FormInput.add(LabelKustom10);
        LabelKustom10.setBounds(454, 370, 150, 23);
        ...
        LabelKustom9.setName("LabelKustom9"); // NOI18N
        LabelKustom9.setVisible(false);
        FormInput.add(LabelKustom9);
        LabelKustom9.setBounds(44, 370, 150, 23);
        ...
        LabelKustom11.setName("LabelKustom11"); // NOI18N
        LabelKustom11.setVisible(false);
        FormInput.add(LabelKustom11);
        LabelKustom11.setBounds(0, 440, 77, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("pemberian_informasi_medis_dan_non_medis","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Pernyataan",49,new String[]{
                    ...
                    JenisInformasi.getSelectedItem().toString(),LabelKustom1.getText(),LabelKustom2.getText(),LabelKustom3.getText(),LabelKustom4.getText(),LabelKustom5.getText(),
                    LabelKustom6.getText(),LabelKustom7.getText(),LabelKustom8.getText(),LabelKustom9.getText(),LabelKustom10.getText(),LabelKustom11.getText()
                })==true){
            ...
            try{
                ...
                if(TCari.getText().trim().equals("")){
                    ps=koneksi.prepareStatement(
                            "select pemberian_informasi_medis_dan_non_medis.no_pernyataan,reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,"+
                            "pemberian_informasi_medis_dan_non_medis.tanggal,pemberian_informasi_medis_dan_non_medis.diagnosa,pemberian_informasi_medis_dan_non_medis.diagnosa_konfirmasi,pemberian_informasi_medis_dan_non_medis.tindakan,"+
                            "pemberian_informasi_medis_dan_non_medis.tindakan_konfirmasi,pemberian_informasi_medis_dan_non_medis.indikasi_tindakan,pemberian_informasi_medis_dan_non_medis.indikasi_tindakan_konfirmasi,"+
                            "pemberian_informasi_medis_dan_non_medis.tata_cara,pemberian_informasi_medis_dan_non_medis.tata_cara_konfirmasi,pemberian_informasi_medis_dan_non_medis.tujuan,pemberian_informasi_medis_dan_non_medis.tujuan_konfirmasi,"+
                            "pemberian_informasi_medis_dan_non_medis.risiko,pemberian_informasi_medis_dan_non_medis.risiko_konfirmasi,pemberian_informasi_medis_dan_non_medis.komplikasi,pemberian_informasi_medis_dan_non_medis.komplikasi_konfirmasi,"+
                            "pemberian_informasi_medis_dan_non_medis.prognosis,pemberian_informasi_medis_dan_non_medis.prognosis_konfirmasi,pemberian_informasi_medis_dan_non_medis.alternatif_dan_risikonya,"+
                            "pemberian_informasi_medis_dan_non_medis.alternatif_konfirmasi,pemberian_informasi_medis_dan_non_medis.biaya,pemberian_informasi_medis_dan_non_medis.biaya_konfirmasi,pemberian_informasi_medis_dan_non_medis.lain_lain,"+
                            "pemberian_informasi_medis_dan_non_medis.lain_lain_konfirmasi,pemberian_informasi_medis_dan_non_medis.kd_dokter,dokter.nm_dokter,pemberian_informasi_medis_dan_non_medis.nip,petugas.nama,"+
                            "pemberian_informasi_medis_dan_non_medis.penerima_informasi,pemberian_informasi_medis_dan_non_medis.alasan_diwakilkan_penerima_informasi,pemberian_informasi_medis_dan_non_medis.jk_penerima_informasi,"+
                            "pemberian_informasi_medis_dan_non_medis.tanggal_lahir_penerima_informasi,pemberian_informasi_medis_dan_non_medis.umur_penerima_informasi,pemberian_informasi_medis_dan_non_medis.alamat_penerima_informasi,"+
                            "pemberian_informasi_medis_dan_non_medis.no_hp,pemberian_informasi_medis_dan_non_medis.hubungan_penerima_informasi,pemberian_informasi_medis_dan_non_medis.pernyataan,pemberian_informasi_medis_dan_non_medis.saksi_keluarga,"+
                        "pemberian_informasi_medis_dan_non_medis.jenis_informasi,pemberian_informasi_medis_dan_non_medis.label_item1,pemberian_informasi_medis_dan_non_medis.label_item2,pemberian_informasi_medis_dan_non_medis.label_item3,pemberian_informasi_medis_dan_non_medis.label_item4,pemberian_informasi_medis_dan_non_medis.label_item5,"+
                        "pemberian_informasi_medis_dan_non_medis.label_item6,pemberian_informasi_medis_dan_non_medis.label_item7,pemberian_informasi_medis_dan_non_medis.label_item8,pemberian_informasi_medis_dan_non_medis.label_item9,pemberian_informasi_medis_dan_non_medis.label_item10,pemberian_informasi_medis_dan_non_medis.label_item11 "+
                            "from pemberian_informasi_medis_dan_non_medis inner join reg_periksa on pemberian_informasi_medis_dan_non_medis.no_rawat=reg_periksa.no_rawat "+
                            "inner join pasien on pasien.no_rkm_medis=reg_periksa.no_rkm_medis "+
                            "inner join dokter on dokter.kd_dokter=pemberian_informasi_medis_dan_non_medis.kd_dokter "+
                            "inner join petugas on petugas.nip=pemberian_informasi_medis_dan_non_medis.nip where "+
                            "pemberian_informasi_medis_dan_non_medis.tanggal between ? and ? order by pemberian_informasi_medis_dan_non_medis.tanggal");
                }else{
                    ps=koneksi.prepareStatement(
                            "select pemberian_informasi_medis_dan_non_medis.no_pernyataan,reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,"+
                            "pemberian_informasi_medis_dan_non_medis.tanggal,pemberian_informasi_medis_dan_non_medis.diagnosa,pemberian_informasi_medis_dan_non_medis.diagnosa_konfirmasi,pemberian_informasi_medis_dan_non_medis.tindakan,"+
                        ...
                        "pemberian_informasi_medis_dan_non_medis.label_item6,pemberian_informasi_medis_dan_non_medis.label_item7,pemberian_informasi_medis_dan_non_medis.label_item8,pemberian_informasi_medis_dan_non_medis.label_item9,pemberian_informasi_medis_dan_non_medis.label_item10,pemberian_informasi_medis_dan_non_medis.label_item11 "+
                            ...
                            "inner join dokter on dokter.kd_dokter=pemberian_informasi_medis_dan_non_medis.kd_dokter "+
                            "inner join petugas on petugas.nip=pemberian_informasi_medis_dan_non_medis.nip where "+
                            "pemberian_informasi_medis_dan_non_medis.tanggal between ? and ? and (pemberian_informasi_medis_dan_non_medis.no_pernyataan like ? or reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                            "petugas.nip like ? or petugas.nama like ? or pemberian_informasi_medis_dan_non_medis.kd_dokter like ? or dokter.nm_dokter like ?) order by pemberian_informasi_medis_dan_non_medis.tanggal");
                }
                        ...
                        case "Laporan 1 (HTML)":
                                ...
                                htmlContent.append(                             
                                    "<tr class='isi'>"+
                                        ...
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Jenis Informasi</td>"+
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Label 1</td>"+
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Label 2</td>"+
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Label 3</td>"+
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Label 4</td>"+
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Label 5</td>"+
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Label 6</td>"+
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Label 7</td>"+
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Label 8</td>"+
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Label 9</td>"+
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Label 10</td>"+
                                        "<td valign='middle' bgcolor='#FFFAF8' align='center'>Label 11</td>"+
                                    "</tr>"
                                );
                                while(rs.next()){
                                    htmlContent.append(
                                        "<tr class='isi'>"+
                                            ...
                                            "<td valign='top'>"+rs.getString("jenis_informasi")+"</td>"+
                                            "<td valign='top'>"+rs.getString("label_item1")+"</td>"+
                                            "<td valign='top'>"+rs.getString("label_item2")+"</td>"+
                                            "<td valign='top'>"+rs.getString("label_item3")+"</td>"+
                                            "<td valign='top'>"+rs.getString("label_item4")+"</td>"+
                                            "<td valign='top'>"+rs.getString("label_item5")+"</td>"+
                                            "<td valign='top'>"+rs.getString("label_item6")+"</td>"+
                                            "<td valign='top'>"+rs.getString("label_item7")+"</td>"+
                                            "<td valign='top'>"+rs.getString("label_item8")+"</td>"+
                                            "<td valign='top'>"+rs.getString("label_item9")+"</td>"+
                                            "<td valign='top'>"+rs.getString("label_item10")+"</td>"+
                                            "<td valign='top'>"+rs.getString("label_item11")+"</td>"+
                                        "</tr>"
                                    );
                                }
    ...
    private void JenisInformasiItemStateChanged(java.awt.event.ItemEvent evt) {
        if(evt.getStateChange()==java.awt.event.ItemEvent.SELECTED){
            boolean nonMedis = JenisInformasi.getSelectedItem().toString().equals("Non Medis");
            jLabel82.setVisible(!nonMedis);
            jLabel83.setVisible(!nonMedis);
            jLabel84.setVisible(!nonMedis);
            jLabel85.setVisible(!nonMedis);
            jLabel86.setVisible(!nonMedis);
            jLabel87.setVisible(!nonMedis);
            jLabel88.setVisible(!nonMedis);
            jLabel89.setVisible(!nonMedis);
            jLabel90.setVisible(!nonMedis);
            jLabel91.setVisible(!nonMedis);
            jLabel12.setVisible(!nonMedis);
            LabelKustom1.setVisible(nonMedis);
            LabelKustom2.setVisible(nonMedis);
            LabelKustom3.setVisible(nonMedis);
            LabelKustom4.setVisible(nonMedis);
            LabelKustom5.setVisible(nonMedis);
            LabelKustom6.setVisible(nonMedis);
            LabelKustom7.setVisible(nonMedis);
            LabelKustom8.setVisible(nonMedis);
            LabelKustom9.setVisible(nonMedis);
            LabelKustom10.setVisible(nonMedis);
            LabelKustom11.setVisible(nonMedis);
        }
    }
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(tbObat.getSelectedRow()>-1){
                if(tbObat.getValueAt(tbObat.getSelectedRow(),41).toString().equals("Belum Dikonfirmasi")){
                    Sequel.queryu("delete from antripemberianinformasi");
                    Sequel.queryu("insert into antripemberianinformasi values('"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"','"+tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()+"')");
                    Sequel.queryu("delete from bukti_pemberian_informasi_medis_dan_non_medis_penerimainformasi where no_pernyataan='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'");
                    Sequel.queryu("delete from bukti_pemberian_informasi_medis_dan_non_medis_saksikeluarga where no_pernyataan='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'");
                }else{
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(lokasifile.equals("")){
                ...
                param.put("photo_penerima","http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/pemberianinformasimedisdannonmedis/"+lokasifile);
                param.put("photo_saksi","http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/pemberianinformasimedisdannonmedis/"+lokasifile2);
                ...
                Valid.MyReportqry("rptSuratPemberianInformasiMedisDanNonMedis.jasper","report","::[ Surat Pemberian Informasi Medis dan Non Medis ]::",
                    "select pemberian_informasi_medis_dan_non_medis.no_pernyataan,reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,pasien.tmp_lahir,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat,pemberian_informasi_medis_dan_non_medis.tanggal,pemberian_informasi_medis_dan_non_medis.diagnosa,pemberian_informasi_medis_dan_non_medis.diagnosa_konfirmasi,pemberian_informasi_medis_dan_non_medis.tindakan,"+
		    "pemberian_informasi_medis_dan_non_medis.tindakan_konfirmasi,pemberian_informasi_medis_dan_non_medis.indikasi_tindakan,pemberian_informasi_medis_dan_non_medis.indikasi_tindakan_konfirmasi,pemberian_informasi_medis_dan_non_medis.tata_cara,pemberian_informasi_medis_dan_non_medis.tata_cara_konfirmasi,pemberian_informasi_medis_dan_non_medis.tujuan,pemberian_informasi_medis_dan_non_medis.tujuan_konfirmasi,pemberian_informasi_medis_dan_non_medis.risiko,pemberian_informasi_medis_dan_non_medis.risiko_konfirmasi,"+
                    "pemberian_informasi_medis_dan_non_medis.komplikasi,pemberian_informasi_medis_dan_non_medis.komplikasi_konfirmasi,pemberian_informasi_medis_dan_non_medis.prognosis,pemberian_informasi_medis_dan_non_medis.prognosis_konfirmasi,pemberian_informasi_medis_dan_non_medis.alternatif_dan_risikonya,pemberian_informasi_medis_dan_non_medis.alternatif_konfirmasi,pemberian_informasi_medis_dan_non_medis.biaya,pemberian_informasi_medis_dan_non_medis.biaya_konfirmasi,pemberian_informasi_medis_dan_non_medis.lain_lain,"+
		    "pemberian_informasi_medis_dan_non_medis.lain_lain_konfirmasi,pemberian_informasi_medis_dan_non_medis.kd_dokter,dokter.nm_dokter,pemberian_informasi_medis_dan_non_medis.nip,petugas.nama,pemberian_informasi_medis_dan_non_medis.penerima_informasi,pemberian_informasi_medis_dan_non_medis.alasan_diwakilkan_penerima_informasi,pemberian_informasi_medis_dan_non_medis.jk_penerima_informasi,pemberian_informasi_medis_dan_non_medis.tanggal_lahir_penerima_informasi,pemberian_informasi_medis_dan_non_medis.umur_penerima_informasi,"+
                    "pemberian_informasi_medis_dan_non_medis.alamat_penerima_informasi,pemberian_informasi_medis_dan_non_medis.no_hp,pemberian_informasi_medis_dan_non_medis.hubungan_penerima_informasi,pemberian_informasi_medis_dan_non_medis.pernyataan,pemberian_informasi_medis_dan_non_medis.saksi_keluarga,reg_periksa.umurdaftar,reg_periksa.sttsumur from pemberian_informasi_medis_dan_non_medis inner join reg_periksa on pemberian_informasi_medis_dan_non_medis.no_rawat=reg_periksa.no_rawat inner join pasien on pasien.no_rkm_medis=reg_periksa.no_rkm_medis "+
		    "inner join dokter on dokter.kd_dokter=pemberian_informasi_medis_dan_non_medis.kd_dokter inner join petugas on petugas.nip=pemberian_informasi_medis_dan_non_medis.nip inner join kelurahan on pasien.kd_kel=kelurahan.kd_kel inner join kecamatan on pasien.kd_kec=kecamatan.kd_kec inner join kabupaten on pasien.kd_kab=kabupaten.kd_kab inner join propinsi on pasien.kd_prop=propinsi.kd_prop "+
                    "where pemberian_informasi_medis_dan_non_medis.no_pernyataan='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
            }
        }else{
    ...
    private void TabDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabDataMouseClicked
        if(TabData.getSelectedIndex()==0){
            if(lokasifile.equals("")){
                ...
                LoadHTML2.setText("<html><body><center><img src='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/pemberianinformasimedisdannonmedis/"+lokasifile+"' alt='photo' width='450' height='550'/></center></body></html>");
            } 
        }else{
            if(lokasifile2.equals("")){
                ...
                LoadHTML3.setText("<html><body><center><img src='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/pemberianinformasimedisdannonmedis/"+lokasifile2+"' alt='photo' width='450' height='550'/></center></body></html>");
            } 
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratPemberianInformasiMedisDanNonMedis dialog = new SuratPemberianInformasiMedisDanNonMedis(new javax.swing.JFrame(), true);
    ...
    private widget.ComboBox JenisInformasi;
    ...
    private widget.Label jLabelJenisInformasi;
    private widget.TextBox LabelKustom1;
    private widget.TextBox LabelKustom2;
    private widget.TextBox LabelKustom3;
    private widget.TextBox LabelKustom4;
    private widget.TextBox LabelKustom5;
    private widget.TextBox LabelKustom6;
    private widget.TextBox LabelKustom7;
    private widget.TextBox LabelKustom8;
    private widget.TextBox LabelKustom9;
    private widget.TextBox LabelKustom10;
    private widget.TextBox LabelKustom11;
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("saksi_keluarga"),rs.getString("jenis_informasi"),
                        rs.getString("label_item1"),rs.getString("label_item2"),rs.getString("label_item3"),rs.getString("label_item4"),
                        rs.getString("label_item5"),rs.getString("label_item6"),rs.getString("label_item7"),rs.getString("label_item8"),
                        rs.getString("label_item9"),rs.getString("label_item10"),rs.getString("label_item11")
                    });
                }
    ...
    public void emptTeks() {
        ...
        JenisInformasi.setSelectedIndex(0);
        LabelKustom1.setText("");
        LabelKustom2.setText("");
        LabelKustom3.setText("");
        LabelKustom4.setText("");
        LabelKustom5.setText("");
        LabelKustom6.setText("");
        LabelKustom7.setText("");
        LabelKustom8.setText("");
        LabelKustom9.setText("");
        LabelKustom10.setText("");
        LabelKustom11.setText("");
        ...
        LabelKustom10.setVisible(false);
        LabelKustom11.setVisible(false);
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(pemberian_informasi_medis_dan_non_medis.no_pernyataan,3),signed)),0) from pemberian_informasi_medis_dan_non_medis where pemberian_informasi_medis_dan_non_medis.tanggal='"+Valid.SetTgl(TglPernyataan.getSelectedItem()+"")+"' ",
                "PI"+TglPernyataan.getSelectedItem().toString().substring(6,10)+TglPernyataan.getSelectedItem().toString().substring(3,5)+TglPernyataan.getSelectedItem().toString().substring(0,2),3,NoPenyataan);
        TabRawat.setSelectedIndex(0);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            JenisInformasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),43).toString());
            LabelKustom1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),44).toString());
            LabelKustom2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),45).toString());
            LabelKustom3.setText(tbObat.getValueAt(tbObat.getSelectedRow(),46).toString());
            LabelKustom4.setText(tbObat.getValueAt(tbObat.getSelectedRow(),47).toString());
            LabelKustom5.setText(tbObat.getValueAt(tbObat.getSelectedRow(),48).toString());
            LabelKustom6.setText(tbObat.getValueAt(tbObat.getSelectedRow(),49).toString());
            LabelKustom7.setText(tbObat.getValueAt(tbObat.getSelectedRow(),50).toString());
            LabelKustom8.setText(tbObat.getValueAt(tbObat.getSelectedRow(),51).toString());
            LabelKustom9.setText(tbObat.getValueAt(tbObat.getSelectedRow(),52).toString());
            LabelKustom10.setText(tbObat.getValueAt(tbObat.getSelectedRow(),53).toString());
            LabelKustom11.setText(tbObat.getValueAt(tbObat.getSelectedRow(),54).toString());
        }
    }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpemberian_informasi_medis_dan_non_medis());
        BtnHapus.setEnabled(akses.getpemberian_informasi_medis_dan_non_medis());
        BtnEdit.setEnabled(akses.getpemberian_informasi_medis_dan_non_medis());
        BtnEdit.setEnabled(akses.getpemberian_informasi_medis_dan_non_medis());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from pemberian_informasi_medis_dan_non_medis where no_pernyataan=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("pemberian_informasi_medis_dan_non_medis","no_pernyataan=?","no_pernyataan=?,no_rawat=?,tanggal=?,diagnosa=?,diagnosa_konfirmasi=?,tindakan=?,tindakan_konfirmasi=?,indikasi_tindakan=?,indikasi_tindakan_konfirmasi=?,tata_cara=?,tata_cara_konfirmasi=?,tujuan=?,tujuan_konfirmasi=?,risiko=?,risiko_konfirmasi=?,komplikasi=?,komplikasi_konfirmasi=?,prognosis=?,prognosis_konfirmasi=?,alternatif_dan_risikonya=?,alternatif_konfirmasi=?,biaya=?,biaya_konfirmasi=?,lain_lain=?,lain_lain_konfirmasi=?,kd_dokter=?,nip=?,penerima_informasi=?,alasan_diwakilkan_penerima_informasi=?,jk_penerima_informasi=?,tanggal_lahir_penerima_informasi=?,umur_penerima_informasi=?,alamat_penerima_informasi=?,no_hp=?,hubungan_penerima_informasi=?,pernyataan=?,saksi_keluarga=?,jenis_informasi=?,label_item1=?,label_item2=?,label_item3=?,label_item4=?,label_item5=?,label_item6=?,label_item7=?,label_item8=?,label_item9=?,label_item10=?,label_item11=?",50,new String[]{
                NoPenyataan.getText(),TNoRw.getText(),Valid.SetTgl(TglPernyataan.getSelectedItem()+""),Diagnosa.getText(),"false",TindakanKedokteran.getText(),"false",
                IndikasiTindakan.getText(),"false",TataCara.getText(),"false",Tujuan.getText(),"false",Risiko.getText(),"false",Komplikasi.getText(),"false",Prognosis.getText(), 
                "false",AlternatifResiko.getText(),"false",Biaya.getText(),"false",LainLain.getText(),"false",KdDokter.getText(),KdPerawat.getText(),PenerimaInformasi.getText(),
                AlasanDiwakilkan.getText(),JKPenerima.getSelectedItem().toString().substring(0,1),Valid.SetTgl(TglLahirPenerima.getSelectedItem()+""),UmurPenerima.getText(),
    ...
    private void panggilPhoto() {
        if(FormPhoto.isVisible()==true){
            lokasifile="";
            try {
                ps=koneksi.prepareStatement("select bukti_pemberian_informasi_medis_dan_non_medis_penerimainformasi.photo from bukti_pemberian_informasi_medis_dan_non_medis_penerimainformasi where bukti_pemberian_informasi_medis_dan_non_medis_penerimainformasi.no_pernyataan=?");
                try {
            ...
            lokasifile2="";
            try {
                ps=koneksi.prepareStatement("select bukti_pemberian_informasi_medis_dan_non_medis_saksikeluarga.photo from bukti_pemberian_informasi_medis_dan_non_medis_saksikeluarga where bukti_pemberian_informasi_medis_dan_non_medis_saksikeluarga.no_pernyataan=?");
                try {
                    ps.setString(1,tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
                    rs=ps.executeQuery();
                    if(rs.next()){
