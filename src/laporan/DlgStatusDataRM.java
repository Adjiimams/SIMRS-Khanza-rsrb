...
public final class DlgStatusDataRM extends javax.swing.JDialog {
    ...
    public DlgStatusDataRM(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Resume Ralan", "Resume Ranap", "Triase IGD", "Askep IGD", "Asmed IGD", "ICD 10", "ICD 9",
            "Askep Ralan", "Asmed Ralan IPD", "Asmed Mata", "Askep Gigi", "Askep Obgyn", "Asmed Obgyn",
            "Askep Bayi/Anak", "Asmed Bayi/Anak", "Askep Psikiatri", "Fisioterapi", "Asmed Rehab", "Asmed Psikiatri",
            "Asmed Bedah", "Asmed Neurologi", "Asmed Paru", "MCU", "Asmed Kulit Kelamin", "Asmed Orthopedi",
            "Asmed Hemodialisa", "Asmed Bedah Mulut", "Askep Geriatri", "Asmed Geratri", "Asmed THT", "SEP"
        }) {
            @Override
...
// Set ukuran kolom menggunakan switch-case
        for (i = 0; i < 40; i++) {
            ...
            switch (i) {
                ...
                case 20: // Askep Obgyn
                case 21: // Asmed Obgyn
                case 22: // Askep Bayi/Anak
                case 23: // Asmed Bayi/Anak
                case 24: // Askep Psikiatri
                case 25: // Fisioterapi
                    column.setMinWidth(0);
                    column.setMaxWidth(0);
                    break;
                case 26: // Asmed Rehab
                case 27: // Asmed Psikiatri
                    column.setMinWidth(0);
                    column.setMaxWidth(0);
                    break;
                case 28: // Asmed Bedah
                case 29: // Asmed Neurologi
                    column.setMinWidth(0);
                    column.setMaxWidth(0);
                    break;
                case 30: // Asmed Paru
                    ...
                    break;
                case 31: // MCU
                case 32: // Asmed Kulit Kelamin
                    column.setMinWidth(0);
                    column.setMaxWidth(0);
                    break;
                case 33: // Asmed Orthopedi
                    column.setMinWidth(0);
                    column.setMaxWidth(0);
                    break;
                case 34: // Asmed Hemodialisa
                    column.setMinWidth(0);
                    column.setMaxWidth(0);
                    break;
                case 35: // Asmed Bedah Mulut
                case 36: // Askep Geriatri
                    column.setMinWidth(0);
                    column.setMaxWidth(0);
                    break;
                case 37: // Asmed Geratri
                    column.setMinWidth(0);
                    column.setMaxWidth(0);
                    break;
                case 38: // Asmed THT
                    ...
                    break;
                case 39: // SEP
                    column.setPreferredWidth(84); // Kolom lainnya
                    break;
            }
        }
        ...
        tabMode6 = new DefaultTableModel(null, new Object[]{
            "No.Rawat", "Tanggal", "Dokter DPJP", "Nomer RM", "Pasien", "Kamar Inap", "Status", "Askep Ranap", "Asmed Ranap"
        }) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
    ...
    private void initComponents() {
        ...
        TabRawat.addTab("Rawat Inap", internalFrame7);
    ...
    public void tampil5() {
        try {
            ...
            ps5 = koneksi.prepareStatement(
                    ...
                    + "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join penjab on reg_periksa.kd_pj=penjab.kd_pj where  "
                    + "concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? "
                    + "and reg_periksa.tgl_registrasi between ? and ? and reg_periksa.status_lanjut like ? and poliklinik.kd_poli='IGDK'  "
                    + (TCari.getText().equals("") ? "" : "and (reg_periksa.no_rawat like ? or dokter.nm_dokter like ? or reg_periksa.no_rkm_medis like ? or "
                    + "pasien.nm_pasien like ? or penjab.png_jawab like ?) ") + "order by reg_periksa.tgl_registrasi");
            try {
    ...
    public void tampil6(){
        try {
            ...
            try {
                ...
                tidak_ada_observasiigd = 0;
                while (rs6.next()) {
                    transferantarruang = Sequel.cariIsi("select if(count(transfer_pasien_antar_ruang.no_rawat)>0,'Ada','Tidak Ada') from transfer_pasien_antar_ruang where transfer_pasien_antar_ruang.no_rawat=?", rs6.getString("no_rawat"));
                    if (transferantarruang.equals("Ada")) {
                        ada_transferantarruang++;
                    } else {
                        tidak_ada_transferantarruang++;
                    ...
                    observasiigd = Sequel.cariIsi("select if(count(catatan_observasi_igd.no_rawat)>0,'Ada','Tidak Ada') from catatan_observasi_igd where catatan_observasi_igd.no_rawat=?", rs6.getString("no_rawat"));
                    if (observasiigd.equals("Ada")) {
                        ada_observasiigd++;
                    } else {
                        tidak_ada_observasiigd++;
